  ...
  return (
    <div className="min-h-screen bg-blue-50 bg-opacity-50 font-sans">
      ...
      <div className="container mx-auto px-4 py-8">
        {/* Back Button */}
        <div className="mb-8">
          <Link to="/results" className="inline-flex items-center text-purple-700 hover:text-purple-800 transition-colors">
              ...
              <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="md:w-1/2">
                  <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                    <span className="bg-yellow-100 p-2 rounded-md mr-3">
                  ...
                  <div className="bg-gray-50 rounded-lg p-6 border border-gray-200 mb-6">
                    ...
                    {plan.trial && (
                      <div className="bg-blue-50 border border-blue-100 rounded-md p-3 text-sm text-blue-700 mb-4">
                ...
                <div className="md:w-1/2">
                  {isComplete ? (
                    <div className="flex flex-col items-center justify-center h-full py-12">
                      ...
                      <p className="text-gray-600 text-center mb-6">Thank you for your purchase. You're being redirected to your dashboard.</p>
                    ...
                    <>
                      ...
                      <div className="flex border-b border-gray-200 mb-6">
                        <button
                          className={`py-3 px-6 font-medium ${activeTab === 'signup' ? 'text-purple-600 border-b-2 border-purple-600' : 'text-gray-500 hover:text-gray-700'}`}
                          onClick={() => setActiveTab('signup')}
                        >
                          Sign Up
                        </button>
                        <button
                          className={`py-3 px-6 font-medium ${activeTab === 'login' ? 'text-purple-600 border-b-2 border-purple-600' : 'text-gray-500 hover:text-gray-700'}`}
                        ...
                        {activeTab === 'signup' && (
                          <div className="mb-4">
                            ...
                            <div className="relative">
                              ...
                              <input
                                type="text"
                                className="pl-10 w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="font-medium">James Anderson</h4>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <div className="flex items-center">
                <div className="w-10 h-10 bg-gray-300 rounded-full mr-3"></div>
                <div>
                  <h4 className="font-medium">Olivia Morgan</h4>
                  <div className="flex text-yellow-400">
                    <span>★★★★★</span>
                  </div>
                </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <div className="flex items-center">
                <div className="w-10 h-10 bg-gray-300 rounded-full mr-3"></div>
                <div>
                  <h4 className="font-medium">Christopher Lee</h4>
                  <div className="flex text-yellow-400">
                    <span>★★★★★</span>
                  </div>
                </div>
